...
define('htmlbars-compiler-tests/dirtying-test', ['../htmlbars-compiler/compiler', '../htmlbars-runtime/render', '../htmlbars-runtime/hooks', '../htmlbars-util/template-utils', '../htmlbars-util/object-utils', '../dom-helper', '../htmlbars-test-helpers'], function (compiler, render, defaultHooks, template_utils, object_utils, DOMHelper, htmlbars_test_helpers) {
  ...
  function testEachHelper(testName, templateSource) {
    test(testName, function () {
      ...
      htmlbars_test_helpers.equalTokens(result.fragment, "<ul><li class='mmun'>Martin Muñoz</li><li class='mixonic'>Matthew Beale</li></ul>", "After adding an additional entry");
  ...
  test("Setting up a manual element renders and revalidates", function () {
    ...
    htmlbars_test_helpers.equalTokens(result.fragment, "<span title='Tom Dale' data-bar='baz' href='http://tomdale.net'>Hello world!</span>");
  });
  ...
  test("It is possible to nest multiple templates into a manual element", function () {
    ...
    htmlbars_test_helpers.equalTokens(result.fragment, "<span title='Tom Dale' data-bar='baz' href='http://tomdale.net'><em>foo. Hello world!</em></span>");
  });
...
define('htmlbars-compiler-tests/html-compiler-test', ['../htmlbars-compiler/compiler', '../htmlbars-util/array-utils', '../htmlbars-runtime/hooks', '../htmlbars-util/object-utils', '../dom-helper', '../htmlbars-test-helpers'], function (compiler, array_utils, defaultHooks, object_utils, DOMHelper, htmlbars_test_helpers) {
  ...
  var innerHTMLSupportsCustomTags = (function () {
    ...
    return htmlbars_test_helpers.normalizeInnerHTML(div.innerHTML) === "<x-bar></x-bar>";
  })();
  ...
  test("unquoted attribute expression works when followed by another attribute", function () {
    ...
    htmlbars_test_helpers.equalTokens(divNode, "<div foo=\"oh my\" name=\"Alice\"></div>");
  });
...
define('htmlbars-compiler-tests/hydration-opcode-compiler-test', ['../htmlbars-compiler/hydration-opcode-compiler', '../htmlbars-syntax/parser'], function (HydrationOpcodeCompiler, parser) {
  ...
  test("simple example", function () {
    ...
    deepEqual(opcodes, [["consumeParent", [0]], ["shareElement", [0]], ["createMorph", [0, [0], 0, 0, true]], ["createMorph", [1, [0], 2, 2, true]], ["pushLiteral", ["foo"]], ["printContentHook", []], ["pushLiteral", ["baz"]], ["printContentHook", []], ["popParent", []]]);
  });

  test("simple block", function () {
    var opcodes = opcodesFor("<div>{{#foo}}{{/foo}}</div>");
    deepEqual(opcodes, [["consumeParent", [0]], ["createMorph", [0, [0], 0, 0, true]], ["prepareObject", [0]], ["prepareArray", [0]], ["pushLiteral", ["foo"]], ["printBlockHook", [0, null]], ["popParent", []]]);
  });
  ...
  test("element with a sole mustache child", function () {
    ...
    deepEqual(opcodes, [["consumeParent", [0]], ["createMorph", [0, [0], 0, 0, true]], ["pushLiteral", ["foo"]], ["printContentHook", []], ["popParent", []]]);
  });

  test("element with a mustache between two text nodes", function () {
    var opcodes = opcodesFor("<div> {{foo}} </div>");
    deepEqual(opcodes, [["consumeParent", [0]], ["createMorph", [0, [0], 1, 1, true]], ["pushLiteral", ["foo"]], ["printContentHook", []], ["popParent", []]]);
  });

  test("mustache two elements deep", function () {
    var opcodes = opcodesFor("<div><div>{{foo}}</div></div>");
    deepEqual(opcodes, [["consumeParent", [0]], ["consumeParent", [0]], ["createMorph", [0, [0, 0], 0, 0, true]], ["pushLiteral", ["foo"]], ["printContentHook", []], ["popParent", []], ["popParent", []]]);
  });

  test("two sibling elements with mustaches", function () {
    var opcodes = opcodesFor("<div>{{foo}}</div><div>{{bar}}</div>");
    deepEqual(opcodes, [["consumeParent", [0]], ["createMorph", [0, [0], 0, 0, true]], ["pushLiteral", ["foo"]], ["printContentHook", []], ["popParent", []], ["consumeParent", [1]], ["createMorph", [1, [1], 0, 0, true]], ["pushLiteral", ["bar"]], ["printContentHook", []], ["popParent", []]]);
  });

  test("mustaches at the root", function () {
    var opcodes = opcodesFor("{{foo}} {{bar}}");
    deepEqual(opcodes, [["createMorph", [0, [], 0, 0, true]], ["createMorph", [1, [], 2, 2, true]], ["openBoundary", []], ["pushLiteral", ["foo"]], ["printContentHook", []], ["closeBoundary", []], ["pushLiteral", ["bar"]], ["printContentHook", []]]);
  });
  ...
  test("back to back mustaches should have a text node inserted between them", function () {
    ...
    deepEqual(opcodes, [["consumeParent", [0]], ["shareElement", [0]], ["createMorph", [0, [0], 0, 0, true]], ["createMorph", [1, [0], 1, 1, true]], ["createMorph", [2, [0], 2, 2, true]], ["createMorph", [3, [0], 4, 4, true]], ["pushLiteral", ["foo"]], ["printContentHook", []], ["pushLiteral", ["bar"]], ["printContentHook", []], ["pushLiteral", ["baz"]], ["printContentHook", []], ["pushLiteral", ["qux"]], ["printContentHook", []], ["popParent", []]]);
  });

  test("helper usage", function () {
    var opcodes = opcodesFor("<div>{{foo 'bar' baz.bat true 3.14}}</div>");
    deepEqual(opcodes, [["consumeParent", [0]], ["createMorph", [0, [0], 0, 0, true]], ["prepareObject", [0]], ["pushLiteral", [3.14]], ["pushLiteral", [true]], ["pushGetHook", ["baz.bat"]], ["pushLiteral", ["bar"]], ["prepareArray", [4]], ["pushLiteral", ["foo"]], ["printInlineHook", []], ["popParent", []]]);
  });

  test("node mustache", function () {
    var opcodes = opcodesFor("<div {{foo}}></div>");
    deepEqual(opcodes, [["consumeParent", [0]], ["prepareObject", [0]], ["prepareArray", [0]], ["pushLiteral", ["foo"]], ["shareElement", [0]], ["createElementMorph", [0, 0]], ["printElementHook", []], ["popParent", []]]);
  });

  test("node helper", function () {
    var opcodes = opcodesFor("<div {{foo 'bar'}}></div>");
    deepEqual(opcodes, [["consumeParent", [0]], ["prepareObject", [0]], ["pushLiteral", ["bar"]], ["prepareArray", [1]], ["pushLiteral", ["foo"]], ["shareElement", [0]], ["createElementMorph", [0, 0]], ["printElementHook", []], ["popParent", []]]);
  });

  test("attribute mustache", function () {
    var opcodes = opcodesFor("<div class='before {{foo}} after'></div>");
    deepEqual(opcodes, [["consumeParent", [0]], ["pushLiteral", [" after"]], ["pushGetHook", ["foo"]], ["pushLiteral", ["before "]], ["prepareArray", [3]], ["pushConcatHook", [0]], ["pushLiteral", ["class"]], ["shareElement", [0]], ["createAttrMorph", [0, 0, "class", true, null]], ["printAttributeHook", []], ["popParent", []]]);
  });

  test("quoted attribute mustache", function () {
    var opcodes = opcodesFor("<div class='{{foo}}'></div>");
    deepEqual(opcodes, [["consumeParent", [0]], ["pushGetHook", ["foo"]], ["prepareArray", [1]], ["pushConcatHook", [0]], ["pushLiteral", ["class"]], ["shareElement", [0]], ["createAttrMorph", [0, 0, "class", true, null]], ["printAttributeHook", []], ["popParent", []]]);
  });

  test("safe bare attribute mustache", function () {
    var opcodes = opcodesFor("<div class={{foo}}></div>");
    deepEqual(opcodes, [["consumeParent", [0]], ["pushGetHook", ["foo"]], ["pushLiteral", ["class"]], ["shareElement", [0]], ["createAttrMorph", [0, 0, "class", true, null]], ["printAttributeHook", []], ["popParent", []]]);
  });

  test("unsafe bare attribute mustache", function () {
    var opcodes = opcodesFor("<div class={{{foo}}}></div>");
    deepEqual(opcodes, [["consumeParent", [0]], ["pushGetHook", ["foo"]], ["pushLiteral", ["class"]], ["shareElement", [0]], ["createAttrMorph", [0, 0, "class", false, null]], ["printAttributeHook", []], ["popParent", []]]);
  });

  test("attribute helper", function () {
    var opcodes = opcodesFor("<div class='before {{foo 'bar'}} after'></div>");
    deepEqual(opcodes, [["consumeParent", [0]], ["pushLiteral", [" after"]], ["prepareObject", [0]], ["pushLiteral", ["bar"]], ["prepareArray", [1]], ["pushLiteral", ["foo"]], ["pushSexprHook", []], ["pushLiteral", ["before "]], ["prepareArray", [3]], ["pushConcatHook", [0]], ["pushLiteral", ["class"]], ["shareElement", [0]], ["createAttrMorph", [0, 0, "class", true, null]], ["printAttributeHook", []], ["popParent", []]]);
  });
  ...
  test("attribute helpers", function () {
    ...
    deepEqual(opcodes, [["consumeParent", [0]], ["shareElement", [0]], ["pushLiteral", [" after"]], ["prepareObject", [0]], ["pushLiteral", ["bar"]], ["prepareArray", [1]], ["pushLiteral", ["foo"]], ["pushSexprHook", []], ["pushLiteral", ["before "]], ["prepareArray", [3]], ["pushConcatHook", [0]], ["pushLiteral", ["class"]], ["createAttrMorph", [0, 0, "class", true, null]], ["printAttributeHook", []], ["pushGetHook", ["bare"]], ["pushLiteral", ["id"]], ["createAttrMorph", [1, 0, "id", true, null]], ["printAttributeHook", []], ["popParent", []], ["createMorph", [2, [], 1, 1, true]], ["pushLiteral", ["morphThing"]], ["printContentHook", []], ["consumeParent", [2]], ["pushGetHook", ["ohMy"]], ["prepareArray", [1]], ["pushConcatHook", [3]], ["pushLiteral", ["class"]], ["shareElement", [1]], ["createAttrMorph", [3, 1, "class", true, null]], ["printAttributeHook", []], ["popParent", []]]);
  });
...
define('htmlbars-runtime/expression-visitor', ['exports', '../htmlbars-util/object-utils', '../htmlbars-util/morph-utils'], function (exports, object_utils, morph_utils) {
  ...
  var AlwaysDirtyVisitor = object_utils.merge(object_utils.createObject(base), {
    ...
    component: function (node, morph, env, scope, template, visitor) {
      ...
      morph.isDirty = morph.isSubtreeDirty = false;
      env.hooks.component(morph, env, scope, path, paramsAndHash[0], paramsAndHash[1], template.templates[templateId], template.templates[inverseId], visitor);
    }
  });
...
define('htmlbars-runtime/hooks', ['exports', './render', '../morph-range/morph-list', '../htmlbars-util/object-utils', '../htmlbars-util/morph-utils', '../htmlbars-util/template-utils'], function (exports, render, MorphList, object_utils, morph_utils, template_utils) {
  ...
  */
  ...
  function bindBlock(env, scope, block) {
    var blockName = arguments[3] === undefined ? "block" : arguments[3];
  ...
  function handleRedirect(morph, env, scope, path, params, hash, template, inverse, visitor) {
    ...
    if (redirect) {
      switch (redirect) {
        case "component":
          env.hooks.component(morph, env, scope, path, params, hash, template, inverse, visitor);break;
        case "inline":
  ...
  var keywords = {
    ...
    yield: function (morph, env, scope, params, hash, template, inverse, visitor) {
      ...
      var to = env.hooks.getValue(hash.to) || "block";
      if (scope[to]) {
        scope[to](env, params, hash.self, morph, scope, visitor);
      }
      return true;
    }
  ...
  function component(morph, env, scope, tagName, params, attrs, template, inverse, visitor) {
    if (env.hooks.hasHelper(env, scope, tagName)) {
      return env.hooks.block(morph, env, scope, tagName, params, attrs, template, inverse, visitor);
    }
